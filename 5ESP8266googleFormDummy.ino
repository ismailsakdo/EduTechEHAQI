/* Google Form Link Format:
   https://docs.google.com/forms/d/e/YOUR_COMPLETE-LINK/
   viewform?usp=pp_url&entry.2128414819=20&entry.671850365=60&entry.713531188=1000&entry.318084391=100&entry.2115180752=10&entry.1088528795=5
*/
...
void loop() {
  ...
  if (WiFi.status() == WL_CONNECTED) {
    ...
    client.setInsecure();  // Accept all certificates (useful for testing HTTPS on ESP8266)
